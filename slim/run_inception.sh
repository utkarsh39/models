...
python train_image_classifier.py --dataset_name=imagenet --dataset_split_name=train --dataset_dir=${DATASET_DIR} --max_number_of_steps=$1 --batch_size=16 --model_name=inception_v3 > log 2>vlog
